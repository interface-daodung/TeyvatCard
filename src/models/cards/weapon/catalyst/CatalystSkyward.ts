...
export default class CatalystSkyward extends Weapon {
    // static CARD_KEY = 'CatalystSkyward';
    constructor(scene: SceneWithGameManager, x: number, y: number, index: number) {
        const config = getCardConfig('CatalystSkyward') ?? { id: 'catalyst-skyward', name: 'Catalyst Skyward', description: '', category: 'catalyst', rarity: 4 };
